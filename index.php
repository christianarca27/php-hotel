...
<body>
    <div class="container">
        ...
        <form class="border border-1 p-3" action="index.php" method="get">
            <h2>Filtri</h2>

            <div class="form-check form-switch mb-3">
                <label class="form-check-label" for="checkbox-parking">Parcheggio disponibile</label>
                <input class="form-check-input" type="checkbox" name="parking" id="checkbox-parking" <?php echo $isParkingFilterActive == "on" ? "checked" : ""; ?> aria-describedby="basic-addon1">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="basic-addon1">Voto</span>
                <input class="form-control" type="number" min="0" name="vote" id="input-vote"
                    placeholder="Inserisci voto minimo" <?php echo $minVote > 0 ? "value='{$minVote}'" : "" ?>>
            </div>
